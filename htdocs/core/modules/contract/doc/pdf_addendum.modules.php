 ...
 */
class pdf_addendum extends ModelePDFContract
{
        /**
        ...
        public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
        {
                ...
                if ($conf->contract->multidir_output[$conf->entity]) {
                        ...
                        if (file_exists($dir)) {
                                ...
                                // --- Add Terms & Conditions from custom field 'contract_addendum' only if it has content ---
                                if (!empty($object->array_options['options_contract_addendum'])) {
                                        $terms = $object->array_options['options_contract_addendum'];

                                        // Start a new page for the terms
                                        ...
                                        // Print terms; MultiCell handles multiple pages automatically
                                        $pdf->writeHTML($terms, true, false, false, false, '', false, 0, 0, true);
                                }
